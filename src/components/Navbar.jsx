...
const Navbar = ({mx, setIsOpen, state, searchHandler}) => {
  return (
    <>
        <div className={`flex  mt-3 justify-between items-center ${mx}`}>
          <div>
           ...
           <div className='md:flex hidden border border-black gap-0 py-1 items-center w-[45%] radius'>
              <input onChange={(e)=>searchHandler(e.target.value)} type="text" className='px-2 py-2 w-[100%] ml-2' placeholder='Mahsulotlarni kiriting'/>
